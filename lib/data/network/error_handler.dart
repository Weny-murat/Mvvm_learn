...
import 'package:mvvm_learn/data/network/failure.dart';
...
class ErrorHandler implements Exception {
  ...
  ErrorHandler.handle(dynamic error) {
    if (error is DioError) {
      //Dio error demek Api isteğinde gelen hata demek kısaca
...
class ResponseMessage {
  ...
  static const String UNAUTHORISED = "User is unauthorized";
